          ...
          onPressed: () {
            ...
            showDialog(
              ...
              builder: (context) => AlertDialog(
                ...
                content: const Text(
                    'Deseja voltar à lista de entregas disponíveis?'),
                actions: [
                  TextButton(
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const DriverHomeScreen(showAppBar: true),
                        ),
                      );
                    },
                  ),
            ...
            child: Stack(
              children: [
                ...
                GoogleMap(
                  ...
                  zoomControlsEnabled:
                      false, // Usamos nossos próprios controles
                  compassEnabled: true,
                  ...
                  Positioned(
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          "Distância: ${_locationService.formatDistance(_locationService.calculateDistance(_currentLocation!, _destination))}",
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      'Prazo: ${widget.delivery.timestamp.toString().substring(0, 16)}'),
                      ...
                      OutlinedButton.icon(
                        ...
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text(
                                    'Ligando para o cliente... (simulação)')),
                          );
                        },
                      ),
